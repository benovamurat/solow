# Datasets and toy loaders

`solow-datasets` covers synthetic classification and regression generators, geometry benchmarks (moons, circles, Swiss roll), classic loaders (iris, wine, diabetes, breast cancer), and utility helpers for class weights and resampling.
