...
| [Metrics, calibration & interpretability](./metrics.md) | `solow-metrics` | [docs.rs](https://docs.rs/solow-metrics) |
| [Cross-validation, bootstrap & conformal](./cross-validation.md) | `solow-cv` | [docs.rs](https://docs.rs/solow-cv) |
| [Machine learning](./machine-learning.md) | `solow-preprocessing`, `solow-cluster`, `solow-neighbors` | [preprocessing](https://docs.rs/solow-preprocessing) / [cluster](https://docs.rs/solow-cluster) / [neighbors](https://docs.rs/solow-neighbors) |
