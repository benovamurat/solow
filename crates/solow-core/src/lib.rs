...
pub use numeric::{
    compensated_dot, compensated_mean, compensated_mean_and_var, kahan_sum, neumaier_sum, KahanSum,
    NeumaierSum,
};
...
pub mod prelude {
    ...
    pub use crate::numeric::{
        compensated_dot, compensated_mean, compensated_mean_and_var, kahan_sum, neumaier_sum,
        KahanSum, NeumaierSum,
    };
    pub use crate::tools::{
