...
pub use bandwidths::{bw_normal_reference, bw_scott, bw_silverman, select_sigma};
pub use kde::{Bandwidth, KdeFit, KdeUnivariate};
pub use kernel_reg::{KdeMultivariate, KernelReg, RegType};
pub use smoothers::{lowess, LowessFit, LowessOptions};
